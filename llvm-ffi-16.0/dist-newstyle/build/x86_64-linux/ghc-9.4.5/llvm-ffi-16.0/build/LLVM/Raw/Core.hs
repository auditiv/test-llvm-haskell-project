{-# LINE 1 "src/14/LLVM/Raw/Core.hsc" #-}
{-# LANGUAGE Safe #-}
...
{-# LINE 83 "src/14/LLVM/Raw/Core.hsc" #-}

attributeReturnIndex, attributeFunctionIndex :: AttributeIndex
attributeReturnIndex   = AttributeIndex (0)
{-# LINE 86 "src/14/LLVM/Raw/Core.hsc" #-}
attributeFunctionIndex = AttributeIndex (-1)
{-# LINE 87 "src/14/LLVM/Raw/Core.hsc" #-}
...
{-# LINE 119 "src/14/LLVM/Raw/Core.hsc" #-}
newtype Linkage = Linkage Word32
{-# LINE 120 "src/14/LLVM/Raw/Core.hsc" #-}
...
{-# LINE 123 "src/14/LLVM/Raw/Core.hsc" #-}
newtype RealPredicate = RealPredicate Word32
{-# LINE 124 "src/14/LLVM/Raw/Core.hsc" #-}
newtype ThreadLocalMode = ThreadLocalMode Word32
{-# LINE 125 "src/14/LLVM/Raw/Core.hsc" #-}
newtype TypeKind = TypeKind {unTypeKind :: Word32}
{-# LINE 126 "src/14/LLVM/Raw/Core.hsc" #-}
...
{-# LINE 129 "src/14/LLVM/Raw/Core.hsc" #-}
newtype Visibility = Visibility Word32
{-# LINE 130 "src/14/LLVM/Raw/Core.hsc" #-}
