...
defaultTargetTriple = ("x86_64-redhat-linux-gnu")
{-# LINE 628 "src/LLVM/FFI/Core.hsc" #-}
hostTriple          = ("x86_64-unknown-linux-gnu")
{-# LINE 629 "src/LLVM/FFI/Core.hsc" #-}
...
fromCallingConvention c =
    ...
    case c of
        C -> (0)
{-# LINE 664 "src/LLVM/FFI/Core.hsc" #-}
        Fast -> (8)
{-# LINE 665 "src/LLVM/FFI/Core.hsc" #-}
        Cold -> (9)
{-# LINE 666 "src/LLVM/FFI/Core.hsc" #-}
        X86StdCall -> (65)
{-# LINE 667 "src/LLVM/FFI/Core.hsc" #-}
        X86FastCall -> (64)
{-# LINE 668 "src/LLVM/FFI/Core.hsc" #-}
        GHC -> 10
...
fromIntPredicate p =
    ...
    case p of
        IntEQ  -> (32)
{-# LINE 790 "src/LLVM/FFI/Core.hsc" #-}
        IntNE  -> (33)
{-# LINE 791 "src/LLVM/FFI/Core.hsc" #-}
        IntUGT -> (34)
{-# LINE 792 "src/LLVM/FFI/Core.hsc" #-}
        IntUGE -> (35)
{-# LINE 793 "src/LLVM/FFI/Core.hsc" #-}
        IntULT -> (36)
{-# LINE 794 "src/LLVM/FFI/Core.hsc" #-}
        IntULE -> (37)
...
{-# LINE 797 "src/LLVM/FFI/Core.hsc" #-}
        IntSLT -> (40)
{-# LINE 798 "src/LLVM/FFI/Core.hsc" #-}
        IntSLE -> (41)
{-# LINE 799 "src/LLVM/FFI/Core.hsc" #-}
